...
const API_URL = 'http://5.75.185.137:3002/api/ess';
...
<Document>
    ...
    try {
        ...
        const checkUrl = `http://5.75.185.137:3002/api/frontend/loan/records?limit=20`;
    ...
    console.log(`ssh uswege@5.75.185.137 "pm2 logs ess-app --lines 50 --nostream | grep -i '${applicationNumber}'"`);
    console.log('\nOr check for the fix log message:');
    console.log(`ssh uswege@5.75.185.137 "pm2 logs ess-app --lines 100 --nostream | grep 'Using TakeOverAmount'"`);
