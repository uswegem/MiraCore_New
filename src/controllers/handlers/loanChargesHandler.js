...
const handleLoanChargesRequest = async (parsedData, res) => {
    ...
    try {
        ...
        // Persist incoming LOAN_CHARGES_REQUEST to MongoDB
        ...
        if (requestedTenure === null) {
            if (affordabilityType === 'REVERSE') {
                ...
                const possibleTenures = [12, 24]; // Possible tenure options (MAX_TENURE is 24)
            ...
            if (messageDetails.ApplicationNumber || messageDetails.CheckNumber) {
                ...
                try {
                    ...
                    try {
                        ...
                        // use the identifier (application or check number) as the primary key
                    const primaryAppNumber = messageDetails.ApplicationNumber || messageDetails.CheckNumber;
