    ...
    static async createClient(clientData) {
        try {
            ...
            const payload = {
                ...
                ...(clientData.clientTypeId !== undefined
                ...
                // genderId only included when explicitly provided or env var configured
                ...(clientData.genderId !== undefined
                    ? { genderId: clientData.genderId }
                    : (() => {
                        const maleId = process.env.CBS_GENDER_MALE_ID;
                        const femaleId = process.env.CBS_GENDER_FEMALE_ID;
                        if (!maleId && !femaleId) return {};
                        return { genderId: (clientData.gender === 'M' || clientData.sex === 'M')
                            ? parseInt(maleId) : parseInt(femaleId) };
                    })()),
