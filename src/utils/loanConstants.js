...
const LOAN_CONSTANTS = {
  ...
  // ===== LOAN TERMS =====
  DEFAULT_TENURE: 24,                  // 24 months - Default loan tenure
  MAX_TENURE: 24,                     // 24 months - Maximum loan tenure
  TEST_TENURE: 24,                     // 24 months - Tenure used in tests

  // ===== INTEREST RATES & FEES =====
  DEFAULT_INTEREST_RATE: 24,           // 24% - Default annual interest rate
  ADMIN_FEE_RATE: 0.02,                // 2% - Processing fee rate (capitalized)
  INSURANCE_RATE: 0.0075,              // 0.75% per year - Insurance rate (applied × tenure years, deducted upfront)
