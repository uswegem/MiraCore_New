...
const loanMappingSchema = new mongoose.Schema({
  ...
  // Duplicate tracking - stores the _id of the original trace when this is a duplicate
  duplicateOfTrace: {
    type: String,
    index: true,
    sparse: true
  ...
  // Customer banking/contact details (promoted from metadata.clientData for direct access)
  swiftCode: {
    type: String,
    index: true,
    sparse: true
