...
// Manual ESS message routes for admin frontend compatibility.
// Canonical routes remain under /api/*, but these aliases prevent 404s for
// frontend builds that prepend /api/v1 or /api/v1/api.
router.post('/loan-status-request', authMiddleware, loanStatusController.triggerLoanStatusRequest);
router.post('/outgoing-message', authMiddleware, outgoingMessagesController.triggerOutgoingMessage);
router.post('/api/loan-status-request', authMiddleware, loanStatusController.triggerLoanStatusRequest);
router.post('/api/outgoing-message', authMiddleware, outgoingMessagesController.triggerOutgoingMessage);
