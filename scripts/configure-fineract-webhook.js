...
const CBS_BASE_URL = 'https://creditconnect.miracore.app/fineract-provider/api';
const CBS_TENANT = 'creditconnect';
const CBS_USERNAME = 'mifos';
const CBS_PASSWORD = 'password';

// Webhook configuration
const WEBHOOK_URL = process.env.WEBHOOK_URL || 'http://5.75.185.137:3002/api/webhook/mifos';
