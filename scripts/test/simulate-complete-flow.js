...
<Document>
    ...
    try {
        const response1 = await axios.post('http://5.75.185.137:3002/api/loan', loanChargesRequest, {
...
<Document>
    ...
    try {
        const response1 = await axios.post('http://5.75.185.137:3002/api/loan', loanOfferRequest, {
            headers: { 
...
<Document>
    <Data>
        ...
        <MessageDetails>
            ...
            <CallbackUrl>http://5.75.185.137:3002/api/webhook/mifos</CallbackUrl>
    ...
    try {
        const response2 = await axios.post('http://5.75.185.137:3002/api/loan', finalApprovalRequest, {
            headers: { 
                'Content-Type': 'application/xml',
                'X-ESS-Source': 'SIMULATION'
            },
