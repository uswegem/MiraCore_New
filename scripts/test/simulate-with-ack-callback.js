    ...
    try {
        const response = await axios({
            ...
            headers: {
                ...
                'X-Callback-Url': `http://localhost:${PORT}/callback`
            },
            data: xmlPayload,
            timeout: 30000,
...
async function simulateFullLoanFlow() {
    console.log('🚀 Starting Full Loan Flow Simulation\n');
    ...
    try {
        ...
        console.log('\n⏳ Waiting for LOAN_INITIAL_APPROVAL_NOTIFICATION callback...');
        // In real implementation, callback will be received at the /callback endpoint
