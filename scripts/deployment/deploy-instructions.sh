#!/bin/bash
echo "🚀 Manual Deployment Instructions for Admin Portal"
echo "================================================="
echo ""
echo "STEP 1: Deploy ESS Backend (5.75.185.137)"
echo "-------------------------------------------"
...
echo "------------------------------------------------"
echo "curl -X GET http://5.75.185.137:3002/health"
echo "curl -X GET http://5.75.185.137:3002/api/v1/loan/list-products"
echo ""
...
echo "# Replace static data with API call to: http://5.75.185.137:3002/api/v1/loan/list-employee-loan"