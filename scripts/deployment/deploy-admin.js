...
async function deployAdmin() {
    ...
    try {
        ...
        executeCommand(
            `${sshPrefix} "cd ${config.adminPath} && echo 'REACT_APP_API_V1_BASE_URL=/api/v1' > .env"`,
        ...
        console.log(`📱 Admin Portal: https://${config.adminServer}/`);
        console.log(`🔗 API Backend: https://${config.adminServer}/api/v1`);
        console.log(`📊 Grafana: https://${config.adminServer}:3000/`);
