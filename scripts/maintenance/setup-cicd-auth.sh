...
echo "-----------------------------------"
echo ""
ssh uswege@5.75.185.137 "ssh -T git@github.com 2>&1" || echo "⚠️  Authentication test (this is expected if key not added yet)"
echo ""
...
echo ""
ssh uswege@5.75.185.137 "cat ~/.ssh/id_ed25519"
echo ""
...
if ssh uswege@5.75.185.137 "ssh -T git@github.com 2>&1" | grep -q "successfully authenticated"; then
...
if ssh uswege@5.75.185.137 "cd /home/uswege/ess && git fetch origin 2>&1"; then
