...
console.log('��� GENERATING LOAN_INITIAL_APPROVAL_NOTIFICATION XML');
...
try {
    ...
    console.log('��� Ready to send to: https://gateway.ess.utumishi.go.tz/ess-loans/mvtyztwq/consume');
