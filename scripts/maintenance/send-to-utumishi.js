...
console.log('��� SENDING LOAN_INITIAL_APPROVAL_NOTIFICATION TO UTUMISHI');
...
console.log('\n��� Sending to Utumishi...');
console.log('URL: https://gateway.ess.utumishi.go.tz/ess-loans/mvtyztwq/consume');

const callbackUrl = 'https://gateway.ess.utumishi.go.tz/ess-loans/mvtyztwq/consume';
...
axios.post(callbackUrl, signedXml, {
    ...
    console.log('\n��� SUCCESS! Callback sent to Utumishi');
