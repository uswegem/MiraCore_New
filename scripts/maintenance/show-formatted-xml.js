...
console.log('��� LOAN_INITIAL_APPROVAL_NOTIFICATION XML');
console.log('='.repeat(80));
console.log();
console.log(formatXML(signedXml));
console.log();
console.log('='.repeat(80));
console.log('✅ Ready to send to Utumishi at: https://gateway.ess.utumishi.go.tz/ess-loans/mvtyztwq/consume');
