...
const API = axios.create({
  baseURL: 'http://5.75.185.137:3002/api/frontend',
...
- **Logs**: `ssh uswege@5.75.185.137 "pm2 logs ess-app"`
- **Status**: `ssh uswege@5.75.185.137 "pm2 status"`
- **Restart**: `ssh uswege@5.75.185.137 "pm2 restart ess-app"`
