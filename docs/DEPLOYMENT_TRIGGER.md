...
```bash
ssh uswege@5.75.185.137 "cd /home/uswege/ess && grep -n 'handleLoanRestructureAffordability' src/controllers/apiController.js"
```
...
### Monitor Logs
```bash
ssh uswege@5.75.185.137 "cd /home/uswege/ess && tail -f logs/app-2025-12-18.log"
```
