...
```bash
ssh-copy-id uswege@5.75.185.137
```
...
- Check server logs: `ssh uswege@5.75.185.137 "pm2 logs ess-app"`
...
ssh uswege@5.75.185.137 "echo 'Connection successful'"
...
ssh uswege@5.75.185.137 "pm2 list"

# Check port availability
ssh uswege@5.75.185.137 "netstat -tlnp | grep :3002"

# Check logs
ssh uswege@5.75.185.137 "tail -50 /home/uswege/ess/logs/app-$(date +%Y-%m-%d).log"
```

### PM2 Process Issues
```bash
# Restart PM2 manually
ssh uswege@5.75.185.137 "cd /home/uswege/ess && pm2 restart ecosystem.config.js"

# Check PM2 status
ssh uswege@5.75.185.137 "pm2 status"
```
...
- ✅ Health endpoint responds: `curl http://5.75.185.137:3002/health`
