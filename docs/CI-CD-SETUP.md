...
- **Target**: 5.75.185.137 (ESS Backend)
- **Actions**:
...
- **Targets**: 
  ...
  - 5.75.185.137 (Admin API Backend)
- **Actions**:
...
ssh uswege@5.75.185.137 "pm2 list && curl http://localhost:3002/health"

# View logs
ssh uswege@5.75.185.137 "pm2 logs ess-app"

# Restart services manually
ssh uswege@5.75.185.137 "cd /home/uswege/ess && pm2 restart all"
...
- **Health Endpoint**: http://5.75.185.137:3002/health
...
# Check server logs
ssh uswege@5.75.185.137 "tail -f /home/uswege/ess/logs/out.log"

# Check PM2 status
ssh uswege@5.75.185.137 "pm2 status && pm2 logs ess-app --lines 50"

# Restart deployment manually
ssh uswege@5.75.185.137 "cd /home/uswege/ess && npm install && pm2 restart all"
```