...
scp src/controllers/handlers/loanRestructureHandler.js \
    uswege@5.75.185.137:/home/uswege/ess/src/controllers/handlers/

scp src/controllers/handlers/mifosWebhookHandler.js \
    uswege@5.75.185.137:/home/uswege/ess/src/controllers/handlers/

scp src/controllers/apiController.js \
    uswege@5.75.185.137:/home/uswege/ess/src/controllers/
```
...
curl -X POST http://5.75.185.137:3002/api/health
...
```bash
curl -X POST http://5.75.185.137:3002/api/loan \
...
```bash
curl -X POST http://5.75.185.137:3002/api/webhook/mifos \
