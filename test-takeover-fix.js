...
<Document>
    ...
    try {
        ...
        const checkResponse = await axios.get(`http://5.75.185.137:3002/api/frontend/loan/records?applicationNumber=${applicationNumber}`);
    ...
    try {
        ...
        const checkResponse = await axios.get(`http://5.75.185.137:3002/api/frontend/loan/records?applicationNumber=${applicationNumber2}`);
