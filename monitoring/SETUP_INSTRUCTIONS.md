...
Your ESS application now exposes Prometheus metrics at: **http://5.75.185.137:3002/metrics**
...
6. Configure the data source:
   - **Name**: `ESS-Prometheus`
   - **URL**: `http://5.75.185.137:3002` (or your Prometheus server URL)
...
```bash
# Metrics endpoint
curl http://5.75.185.137:3002/metrics

# Health endpoint  
curl http://5.75.185.137:3002/health
```
...
curl -X POST -H "Content-Type: application/xml" \
  ...
  http://5.75.185.137:3002/api/loan
```
...
**Metrics URL**: http://5.75.185.137:3002/metrics  
